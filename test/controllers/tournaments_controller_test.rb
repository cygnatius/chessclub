...
class TournamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament" do
    assert_difference('Tournament.count') do
      post tournaments_url, params: { tournament: { format: @tournament.format, timelimit: @tournament.timelimit, title: @tournament.title } }
    end
  ...
  test "should update tournament" do
    patch tournament_url(@tournament), params: { tournament: { format: @tournament.format, timelimit: @tournament.timelimit, title: @tournament.title } }
